            ...
            >
                ...
                >
                    <span class="cursor-pointer truncate rounded">
                        <!-- OVERRIDE START: Use callto: links -->
                        ...
                        <span v-else>
                            <template v-for="(item, index) in inputValue">
                                <a 
                                    :href="'callto:' + item.value"
                                    class="text-brandColor hover:underline"
                                    @click.stop
                                >
                                    @{{ item.value }}
                                </a>
                                <span class="text-gray-500 dark:text-gray-300">(@{{ item.label }})</span><span v-if="index < inputValue.length - 1">, </span>
                            </template>
                        </span>
                        <!-- OVERRIDE END -->
                    </span>
